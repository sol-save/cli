...
function create() {
    return __awaiter(this, void 0, void 0, function () {
        var keyPair, confirmPassword, password, answer, account, encryptedAccount, web3StrorageApiKey, config, _a, name, socials, bio, github, avatar;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 7:
                    web3StrorageApiKey = (_b.sent()).web3StrorageApiKey;
                ...
                case 9:
                    _a = _b.sent(), name = _a.name, socials = _a.socials, bio = _a.bio, github = _a.github;
                    avatar = "https://github.com/".concat(github, ".png");
